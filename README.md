...
I figured that the best way to begin solving this issue was by deciding which device should route information and which should be in bridge-mode. This was quite easy to determine as the Xfinity XB8 has speeds up to 2.5 gbps, and the nighthawk RAX70 has speeds up to 6.6 gbps. I re-logged into my modem and turned bridge mode on, but 
